...
echo color("Maroon","[•]         ipanxcool.                        \n");
echo color("navy","[•] 		YT IPANX COOL                      \n");
echo color("yellow","# # # # # # # # # # # # # # # # # # # # # # # \n");
function change(){
        $nama = nama();
        ...
        $message = fetch_value($code1,'"message":"','"');
        if(strpos($code1, 'vocher berhasil ')){
        echo "\n".color("green","+] Message: ".$message);
        goto gofood;
        }else{
        echo "\n".color("red","-] Message: ".$message);
        ...
        if(strpos($claim, 'vocher berhasil ')){
        echo "\n".color("green","+] Message: ".$message);
        goto gofood;
        }else{
        echo "\n".color("red","-] Message: ".$message);
        ...
        $expired6 = getStr1('"expiry_date":"','"',$cekvoucher,'6');
         ...
         echo color("red","========( PIN ANDA = 111111 )========")."\n";
         $data2 = '{"pin":"111111"}';
