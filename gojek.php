...
echo color("red","| Auto Daftar Gojek X Klaim Voucher |\n");

echo color("red","| github: ipanxcool |\n");
...
echo "\n".color("yellow","!] Klaim vc AYOCOBAGOJEK");
...
echo "\n".color("yellow","!] Klaim vc COBAINGOJEK");
